...
class Explosion {
  ...
  draw() {
    ...
    ctx.drawImage(
      this.image, this.spriteWidth * this.frame, 0, this.spriteWidth,
...
function drawGameOver() {
  ...
  // create a shadow effect by drawing the text twice and offsetting the second fillText()
  ctx.fillStyle = 'black'
...
// timestamp will be initialized to zero
animate(0)