/* state design pattern to swap between different player states */

// enum to define a set of used constants
export const states = {
  STANDING_LEFT: 0,
  STANDING_RIGHT: 1,
  SITTING_LEFT: 2,
...
// in state design pattern, each state is defined by a separate class
...
export class StandingLeft extends State {
  ...
  // will change player's speed and spritesheet when player enters this.state
  enter() {
  ...
  // will iterate per each animation frame
  handleInput(input) {
